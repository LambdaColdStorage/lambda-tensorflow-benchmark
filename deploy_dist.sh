...
ssh ubuntu@10.0.0.2 "cd /home/ubuntu/lambda-tensorflow-benchmark; ./dist_benchmark.sh \"$GPU_INDEX\" \"$ITERATION\" \"$PS_HOSTS\" \"$WORKER_HOSTS\" \"$REMOTE_TASK_INDEX\"" &  pid_remote=$!
